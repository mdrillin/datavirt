...
public class PropertyItem extends Object implements Serializable {
	...
	public boolean hasValidValue() {
	    ...
	    if(this.isRequired && isStrEmpty(this.value)) {
	        isValid = false;
	    }
	...
	public boolean hasChanged() {
	    ...
	    if(isStrEmpty(this.originalValue)) {
	        hasChanged = isStrEmpty(this.value) ? false : true;
	    } else {
	 ...
	 * @param text
	 */
	private boolean isStrEmpty(String text) {
